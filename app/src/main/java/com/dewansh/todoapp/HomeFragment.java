...
import com.dewansh.todoapp.Adapters.TodoListAdapter;
...
//                final String statusCode = String.valueOf(error.networkResponse.statusCode);
                ...
                try {
                    ...
                    if(errorObject.getString("msg").equals("invalid token")) {
    ...
    public void onItemClick(int position) {
        Toast.makeText(getActivity(), "Task "+ position, Toast.LENGTH_SHORT).show();
    }
